import{C as S,k as g,O as p,n as c,M as _,R as s,S as f,f as C,a as u,c as D,i as b,j as d,b as m,d as $,o as W,p as P}from"./vendor-web3-Crg3vp8f.js";import{W as y}from"./index-CdGTnhtW.js";import{g as E,e as N,f as T}from"./index-LKGjch6g.js";import"./vendor-supabase-BMAxf_4t.js";import"./vendor-react-BFo2YEYC.js";import"./vendor-ethers-BJn_0cFZ.js";import"./vendor-ui-CxWn7IE8.js";import"./vendor-i18n-BD52DD-x.js";var j=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends y{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=S.state.activeChain,i=g.getConnections(n),o=(t=p.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=p.state.remoteFeatures)!=null&&r.emailCapture)return;if(p.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=j([u("w3m-email-verify-otp-view")],I);const F=D`
  wui-icon-box {
