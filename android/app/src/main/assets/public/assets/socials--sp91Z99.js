import{c as O,a as _,i as I,j as S,O as h,q as W,R as f,s as T,b as c,f as C,t as F,u as D,w as U,C as d,k as P,n as u,x as k,S as v,M as R,T as x,y as N}from"./vendor-web3-Crg3vp8f.js";import{n as j,g as l,k as M,o as $,C as q}from"./index-LKGjch6g.js";import"./vendor-supabase-BMAxf_4t.js";import"./vendor-react-BFo2YEYC.js";import"./vendor-ethers-BJn_0cFZ.js";import"./vendor-ui-CxWn7IE8.js";import"./vendor-i18n-BD52DD-x.js";const z=O`
  :host {
...
`;var A=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=U.state.isLegalCheckboxChecked,this.unsubscribe.push(U.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var E;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=(E=h.state.features)==null?void 0:E.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=B;A([l()],L.prototype,"checked",void 0);L=A([_("w3m-connect-socials-view")],L);const G=O`
  wui-logo {
    width: 80px;
    height: 80px;
