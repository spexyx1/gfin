  ...
  const [communities, setCommunities] = useState<Community[]>([
    {
      ...
      description: 'A community for serious cryptocurrency traders to share insights, deals, and market analysis.',
      category: 'trading',
      memberCount: 1247,
      postCount: 3891,
      isPrivate: false,
      rules: ['No financial advice', 'Verify all deals', 'Be respectful'],
    ...
    },
    {
      ...
      description: 'Buy, sell, and discover unique NFTs. Share your collections and find rare pieces.',
      category: 'nft',
      memberCount: 892,
      postCount: 2156,
      isPrivate: false,
      rules: ['Verify authenticity', 'No stolen art', 'Fair pricing'],
      moderators: ['mod3'],
      createdBy: 'user2',
    ...
    {
      id: 'comm3',
      name: 'Hardware Exchange',
      description: 'Trade computer hardware, mining equipment, and tech gadgets with fellow enthusiasts.',
      category: 'hardware',
      memberCount: 634,
      postCount: 1423,
      isPrivate: false,
      rules: ['Test before selling', 'Honest descriptions', 'Safe shipping'],
      moderators: ['mod4'],
      createdBy: 'user3',
      createdAt: new Date('2024-02-10'),
      tags: ['hardware', 'mining', 'tech'],
    },
  ]);
  ...
  const [posts, setPosts] = useState<CommunityPost[]>([
    {
      ...
      communityId: 'comm1',
      type: 'deal',
      title: 'Flash Sale: Premium Mining Rig - 50% Off!',
      content: 'Selling my custom mining rig with RTX 4090s. Perfect for ETH mining or AI workloads. Includes cooling system and PSU. Serious buyers only!',
      price: 2499.99,
      currency: 'USDC',
      location: 'San Francisco, CA',
      category: 'hardware',
      tags: ['mining', 'gpu', 'sale'],
      images: ['https://images.pexels.com/photos/7567482/pexels-photo-7567482.jpeg?auto=compress&cs=tinysrgb&w=400'],
      likes: ['user2', 'user3'],
      shares: 12,
      views: 156,
      ...
      isPromoted: true,
      contactInfo: { method: 'message', value: 'user1' },
    },
    {
      id: 'post2',
      authorId: 'user2',
      communityId: 'comm2',
      type: 'classified',
      title: 'Looking for: Rare CryptoPunk NFTs',
      content: 'Collector seeking rare CryptoPunk NFTs, especially those with unique traits. Willing to pay premium for the right pieces. Have verified funds ready.',
      category: 'nft',
      tags: ['cryptopunk', 'wanted', 'collector'],
      images: [],
      likes: ['user1'],
      shares: 5,
      views: 89,
      ...
      isPromoted: false,
      contactInfo: { method: 'message', value: 'user2' },
    },
    {
      id: 'post3',
      authorId: 'user3',
      type: 'discussion',
      title: 'Market Analysis: DeFi Trends for Q2 2025',
      content: 'Sharing my analysis on upcoming DeFi trends. Seeing strong momentum in yield farming protocols and cross-chain bridges. What are your thoughts?',
      category: 'analysis',
      tags: ['defi', 'analysis', 'trends'],
      images: [],
    ...
    },
    {
      ...
      communityId: 'comm3',
      type: 'deal',
      title: 'Bulk GPU Sale - Perfect for Mining Farm',
      content: 'Liquidating mining farm equipment. 20x RTX 3080 GPUs, all in excellent condition. Selling as complete set or individual units. Includes warranties.',
      price: 899.99,
      currency: 'USDC',
      location: 'Austin, TX',
      category: 'hardware',
      tags: ['gpu', 'mining', 'bulk'],
      images: ['https://images.pexels.com/photos/7567525/pexels-photo-7567525.jpeg?auto=compress&cs=tinysrgb&w=400'],
      likes: ['user1', 'user3'],
      shares: 8,
      views: 234,
      ...
      isPromoted: false,
      contactInfo: { method: 'message', value: 'user4' },
    },
  ]);
