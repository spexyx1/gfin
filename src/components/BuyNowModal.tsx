          ...
          {success ? (
            ...
            <>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xl font-black text-red-400 uppercase">
              ...
              <button
                ...
                className="w-full py-4 bg-red-500 hover:shadow-neon-red disabled:luxe-glass text-black font-black rounded-2xl transition-all duration-200 flex items-center justify-center space-x-2 uppercase active:neon-red-glow"
              >
